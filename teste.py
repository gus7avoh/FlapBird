...
def reiniciar(canos,remover_canos):
...
def tela_inicial(tela, passaro, chao):
    tela.blit(IMAGEM_BACKGROUND, (0, 0))
    chao.desenhar(tela)
...
def menu(chao, passaro, tela, relogio):
    ...
    while menu:
            ...
            tela_inicial(tela, passaro, chao)


def runGame(passaro,chao,canos,tela,pontos,relogio):
...
def main():
    ...
    while(True):
        ...
        menu(chao, passaro, tela, relogio)

        runGame(passaro, chao, canos, tela, pontos, relogio)
