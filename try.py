...
def desenhar_tela(tela, passaro, canos, chao, pontos):# caso eu acrescente algum dado que a tela inicial receber vou ter que mexer no rungame
    BackGround().desenhar(tela, 2)#--------------------------------------------------------------------------------
...
def tela_inicial(tela, passaro, chao, last=0, maximo=0):# caso eu acrescente algum dado que a tela inicial receber vou ter que mexer no menu
...
def menu(chao, passaro, tela, tabelaPontos):
    last = 0
    maximo = 0
    if tabelaPontos:
        last = tabelaPontos[-1]
...
def runGame(passaro,chao,canos,tela,pontos,tabelaPontos):
...
def main():
    ...
    while(True):
        menu(chao, passaro, tela, tabelaPontos)
        runGame(passaro, chao, canos, tela, pontos, tabelaPontos)
